...
def generate_load():
    ...
    print('\033[92m'+ timestamp + f' Sending traffic to the target system at 145.108.225.17:9099' + '\033[0m')

    process =  subprocess.Popen(f"./load-test/runLocust.sh -h 145.108.225.17:9099 -r {int(900)}s", shell=True, preexec_fn=os.setsid)
