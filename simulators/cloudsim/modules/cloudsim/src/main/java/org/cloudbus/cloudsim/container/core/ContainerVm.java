...
//        Log.printLine("The VM list size is:...." + getContainerList().size());
    ...
    public boolean isSuitableForGuest(GuestEntity guest) {
        // // Log.printlnConcat("DEBUG PEs ", getContainerScheduler().getPeCapacity() >= guest.getCurrentRequestedMaxMips());
        // // Log.printlnConcat("DEBUG mips ", getContainerScheduler().getAvailableMips() >= guest.getTotalMips());
        // // Log.printlnConcat("DEBUG ram ", getGuestRamProvisioner().isSuitableForGuest(guest, guest.getCurrentRequestedRam()));
        // // Log.printlnConcat("DEBUG ContainerVM bw ", getGuestBwProvisioner().isSuitableForGuest(guest, guest.getCurrentRequestedBw()));
