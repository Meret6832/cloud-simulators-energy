...
public class NetworkDatacenter extends Datacenter {
    ...
    public NetworkDatacenter(
            ...
            Map<Integer, Integer> hostToSwitchid,
            Map<Integer, Integer> vmtoHostlist,
            Map<Integer, Switch> switchList) throws Exception {
		super(name, characteristics, vmAllocationPolicy, storageList, schedulingInterval);
		VmToSwitchid = vmToSwitchid;
		HostToSwitchid = hostToSwitchid;
		VmtoHostlist = vmtoHostlist;
