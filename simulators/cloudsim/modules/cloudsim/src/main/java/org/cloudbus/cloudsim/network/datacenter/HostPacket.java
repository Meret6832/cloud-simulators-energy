...
public class HostPacket {
    ...
    public int getReceiverGuestId() { return receiverGuestId; }

    public int getReceiverCloudletId() { return receiverCloudletId; }

    public int getSenderGuestId() { return senderGuestId; }

    public long getData() { return data; }

    public int getAccumulatedVirtualizationOverhead() { return accumulatedVirtualizationOverhead; }

    public void setRecvTime(double newRecvTime) { recvTime = newRecvTime; }
}
