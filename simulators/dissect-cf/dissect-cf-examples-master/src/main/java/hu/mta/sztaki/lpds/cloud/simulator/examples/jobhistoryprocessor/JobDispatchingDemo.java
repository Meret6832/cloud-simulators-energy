...
public class JobDispatchingDemo {
    ...
    MultiIaaSJobDispatcher dispatcher = new MultiIaaSJobDispatcher(producer, iaasList);
		...
		if (consolidator != null) {
			// if (Consolidator.getConsolidationRuns() != 0) {
			// 	System.err.println("Total migrations done: " + SimpleConsolidator.migrationCount);
			// 	System.err.println("Number of consolidation runs: " + Consolidator.getConsolidationRuns());
			// 	System.err.println(
			// 			"Consolidator performance: " + duration / Consolidator.getConsolidationRuns() + " ms/consolidation");
			// } else {
