...
public class DirectEnergyMeter extends EnergyMeter
	...
	public boolean startMeter(long interval, boolean dropPriorReading) {
        // System.out.println("DEBUG starting meter with interval=" + interval);
	...
	public void tick(final long fires) {
        ...
        // System.out.println("DEBUG currentPower " + usedPowerState.getCurrentPower(((currentProcessingReport - previousProcessingReport) / maxProcessable)));
		// System.out.println("DEBUG mult fires " + (fires - lastMetered));
